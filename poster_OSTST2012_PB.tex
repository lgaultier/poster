...
% \begin{pcolumn}{0.32}
  \pbox{0.90\columnwidth}{28cm}{linewidth=2mm,framearc=0.1,linecolor=mycyan, fillstyle=gradient,gradangle=0,gradbegin=white,gradend=white, gradmidpoint=1.0,framesep=1em}{
    ...
    {\large
      ...
      \begin{center}
      \pbox{0.90\columnwidth}{}{linewidth=0.5mm,framearc=0.2,linecolor=black, fillstyle=gradient,gradangle=0,gradbegin=white,gradend=mycyan, gradmidpoint=0.0,framesep=3mm, shadowsize=0pt}{ \bf How to complement altimeter data using sub-mesoscale tracer observations from space? }
      \end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
  \pbox{0.90\columnwidth}{25.0cm}{linewidth=2mm,framearc=0.1,linecolor=mycyan,fillstyle=gradient,gradangle=0,gradbegin=white,gradend=white,gradmidpoint=1.0,framesep=1em}{
     \begin{center}{\sc \bf \Large  INVERSION IN A COUPLED PHYSICAL-BIOGEOCHEMICAL MODEL\\[5mm]} \end{center}
    {\large
\ding{226} An idealized coupled physical-biogeochemical model is set up to confirm the efficiency of the method. The model configuration is the following:\\
$\bullet$ Nemo dynamics in a channel is coupled with LOBSTER biogeochemical model. \\
$\bullet$ Channel domain: 478~km $\times$ 500~km $\times$ 4~ km, horizontal resolution: 2km \\ 
$\bullet$ Mesoscale and sub-mesoscale physics result from an unstable baroclinic jet \\  
...
%\begin{center}
\pbox{0.70\columnwidth}{}{linewidth=0.5mm,framearc=0.2,linecolor=black, fillstyle=gradient,gradangle=0,gradbegin=white,gradend=white, gradmidpoint=0.0,framesep=3mm, shadowsize=0pt}{
A perturbed velocity is corrected using the Chlorophyll image and the Sea Surface Temperature of the model. Comparing the corrected velocity with the true one, we found that about 40\% of the error is corrected. 
} \vspace{1cm}
%\end{center}
%\end{minipage}
  } %large
