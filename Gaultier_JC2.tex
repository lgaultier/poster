...
% \begin{pcolumn}{0.32}
  \pbox{0.90\columnwidth}{28cm}{linewidth=2mm,framearc=0.1,linecolor=mycyan, fillstyle=gradient,gradangle=0,gradbegin=white,gradend=white, gradmidpoint=1.0,framesep=1em}{
    ...
    {\large
      ...
      \begin{center}
      \pbox{0.90\columnwidth}{}{linewidth=0.5mm,framearc=0.2,linecolor=black, fillstyle=gradient,gradangle=0,gradbegin=myorange,gradend=myorange, gradmidpoint=0.0,framesep=3mm, shadowsize=0pt}{ \bf How to complement altimeter data using sub-mesoscale tracer observations from space? }
      \end{center}
