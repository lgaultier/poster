...
A perturbed velocity is corrected using the Chlorophyll image and the Sea Surface Temperature of the model. Comparing the corrected velocity with the true one, we found that about 40\% of the error is corrected.} \vspace{1cm}
%\end{center}
\end{minipage}
  } %large
  } %pbax 
