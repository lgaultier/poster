...
\begin{center}
  \pbox{0.90\columnwidth}{31cm}{linewidth=2mm, framearc=0.1, linecolor=mycyan, fillstyle=gradient, gradangle=0, gradbegin=white, gradend=white, gradmidpoint=1.0, framesep=1em}{
    ...
    & {\small \bfChlorophyll observation} \\
    %\hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
  \pbox{0.90\columnwidth}{21.0cm}{linewidth=2mm,framearc=0.1,linecolor=mycyan,fillstyle=gradient,gradangle=0,gradbegin=white,gradend=white,gradmidpoint=1.0,framesep=1em}{
     \begin{center}{\sc \bf \Large  NEW RESULTS: INVERSION ON A MODEL\\[5mm]} \end{center}
    {\large
An idealized coupled physico-biogeochemical model is set up to confirm the efficiency of the method.\\
\ding{226} Model Caracteristics: \\ 
