...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
  \pbox{0.5\columnwidth}{30cm}{linewidth=2mm, framearc=0.1, linecolor=mycyan, fillstyle=gradient, gradangle=0, gradbegin=white, gradend=white, gradmidpoint=1.0, framsep=1em}{
    \begin{center}
    ...
    {\large
    \begin{tikzpicture}
    \node[color=black, text width=09.73cm, text centered] (ptra) at (16,0.48) {
    %\includegraphics[width=1\linewidth]{pict}};
