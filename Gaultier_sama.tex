...
%    \rotatebox{90}{hspace{1cm}\small{OBSERVATION}}
    ...
    & \includegraphics[width=7.20cm]{./pict/s_atl/aviso_20471_s_atl2_oc.eps}
    & \includegraphics[width=8.05cm]{./pict/s_atl/fsle_48_stat_reg_20471__bin0.eps}
...
%    \rotatebox{90}{\hspace{1cm}\small{CORRECTION}}
    \includegraphics[width=7.95cm]{./pict/s_atl/aviso_h_020471_eof_bin1_oc.eps}
   & \includegraphics[width=7.20cm]{./pict/s_atl/aviso_20471_s_atl2_sa_oc.eps}
   & \includegraphics[width=8.05cm]{./pict/s_atl/fsle_48_stat_reg_20471__sa_bin1_oc.eps}
   & \\
 %\hline
  \end{tabular}
\\
