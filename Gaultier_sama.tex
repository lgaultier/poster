...
\newrgbcolor{myred}{1 0.5 0.2}
\newrgbcolor{myorange}{1 0.8 0.3}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Begin of Document
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% Logo
  ...
  \begin{center}
    \includegraphics[width=0.70\textwidth,angle=0]{./pict/logo/logo_cnrs.eps}
    \includegraphics[width=1.29\textwidth,angle=0]{./pict/logo/CNES_LogoTerre.eps}
  \end{center}
  \end{minipage}
%%% Titre
  \begin{minipage}[c][9cm][c]{0.78\textwidth}
  \begin{center}
    {\sc \huge \bf On the inversion of high resolution tracer image for the control of ocean circulations emerging from altimetric data }\\[10mm]
...
%     %{$^{2}$ \it Departement of Oceanography, The Florida State University, Tallahassee, USA}\\
    {\large \it e-mail: lucile.gaultier@legi.grenoble-inp.fr}
    } 
  \end{center}
  \end{minipage}
%%%Logo
...
% %%%% Introduction
  \begin{center}
% \begin{pcolumn}{0.32}
  \pbox{0.90\columnwidth}{28cm}{linewidth=2mm,framearc=0.1,linecolor=mycyan, fillstyle=gradient,gradangle=0,gradbegin=white,gradend=white, gradmidpoint=1.0,framesep=1em}{
    \begin{center} 
      { \bf \Large CONTEXT \\[5mm]}%MOTIVATIONS 
    \end{center}
    {\large
      \ding{226} Lack of resolution in time and space for current altimetric data $\rightarrow$ Observation of the sub-mesoscale resolution ($\simeq$ 50~km) is not possible \\
      \ding{226} Sub-mesoscale filaments can be observed using tracer sensors (SST or Ocean Color image, resolution of image$\simeq$ 1~km and a map a day)
      \begin{center}
      \pbox{0.90\columnwidth}{}{linewidth=0.5mm,framearc=0.2,linecolor=black, fillstyle=gradient,gradangle=0,gradbegin=myorange,gradend=myorange, gradmidpoint=0.0,framesep=3mm, shadowsize=0pt}{ How to complement altimeter data using sub-mesoscale tracer observations from space? }
      \end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
  \pbox{0.90\columnwidth}{45cm}{linewidth=2mm, framearc=0.1, linecolor=mycyan, fillstyle=gradient, gradangle=0, gradbegin=white, gradend=white, gradmidpoint=1.0, framesep=1em}{
    \begin{center}
...
\fi
    ...
    \node[pname,text width=7cm] (OBS) at (9,3.98) {Observation};
...
\begin{center}
  \pbox{0.89\columnwidth}{}{linewidth=0.5mm,framearc=0.2,linecolor=black, fillstyle=gradient,gradangle=0,gradbegin=myorange,gradend=myorange, gradmidpoint=0.0,framesep=3mm, shadowsize=0pt}{Goal: Find the optimal velocity $\vec{u}$ that minimizes the cost function J.} 
\end{center}
  }
  %  \vspace*{0.2cm}
    \begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{center}
  \pbox{0.90\columnwidth}{15.5cm}{linewidth=2mm,framearc=0.1,linecolor=mycyan, fillstyle=gradient,gradangle=0,gradbegin=white,gradend=white,gradmidpoint=1.0,framesep=1em}{
    \begin{center}
...
\end{minipage}
 ...
 \begin{minipage}{0.64\textwidth}
   \vspace*{0.2cm}
\ding{226} FLSE is the exponential rate at which two particles separate from a distance $\delta _0$ to $\delta _f$: $ \lambda=\frac{1}{\tau}\ln{\frac{\delta_f}{\delta_0}}$.\\ 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{center}
%% \begin{pcolumn}{0.32}
  \pbox{0.90\columnwidth}{13cm}{linewidth=2mm,framearc=0.1,linecolor=mycyan, fillstyle=gradient,gradangle=0,gradbegin=white,gradend=white,gradmidpoint=1.0,framesep=1em}{
    \begin{center}
      {\sc \bf \Large TEST CASE: SOUTH ATLANTIC\\[5mm]} 
    \end{center} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
  \pbox{0.90\columnwidth}{31cm}{linewidth=2mm, framearc=0.1, linecolor=mycyan, fillstyle=gradient, gradangle=0, gradbegin=white, gradend=white, gradmidpoint=1.0, framesep=1em}{
    \begin{center}
    ...
    \begin{tabular}{cc|l}
    %\hline
 %    {\small \bf SSH observation}
     {\small \bf Geostrophic velocity}
    & {\small \bf Resulting FSLE}
    & {\small \bf Chlorophyll observation} \\
    %\hline
%    \rotatebox{90}{hspace{1cm}\small{OBSERVATION}}
%    \includegraphics[width=7.95cm]{./pict/s_atl/aviso_h_020471.eps}
     \includegraphics[width=9.90cm]{./pict/s_atl/velmapaviso_20471_s_atl2.eps}
    & \includegraphics[width=11.55cm]{./pict/s_atl/ly_020471_s_atl2_20471.eps}
    & \includegraphics[width=11.43cm]{./pict/s_atl/A2006019163000_L2_LAC_oc.eps} \\
  %   \hline
  %   {\small \bf Corrected SSH}
     {\small \bf Corrected velocity}
    & {\small \bf Resulting FSLE}
    &  {\small \bf SST observation} \\
    % \hline
%    \rotatebox{90}{\hspace{1cm}\small{CORRECTION}}
    \includegraphics[width=9.90cm]{./pict/s_atl/velmapsa_20471_s_atl20080.eps}
   & \includegraphics[width=11.65cm]{./pict/s_atl/ly_0080_s_atl2_20471.eps}
   & \includegraphics[width=11.53cm]{./pict/s_atl/A2006019163000_L2_LAC_sst.eps} \\
 %\hline
  \end{tabular}
\\
The inversion method aims at correcting velocity vectors so as to follow tracer frontal structures.\\
\ding{226} 
Looking at the tracer images and the FSLE computed using the observed AVISO velocity, we can clearly see that the eddy is shifted in AVISO data.  \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
  \pbox{0.93\columnwidth}{26.0cm}{linewidth=2mm,framearc=0.1,linecolor=mycyan,fillstyle=gradient,gradangle=0,gradbegin=white,gradend=white,gradmidpoint=1.0,framesep=0em}{
%\hspace{-1cm}
%\vspace{-1cm}
\begin{tabular}{p{5cm}p{35cm}}
\begin{minipage}{1\linewidth}
\rotatebox{30}{\bf \textcolor{myred}{BRAND NEW}}
\end{minipage}
 &\begin{minipage}{0.8\linewidth}
\begin{center}
{\sc \bf \Large  INVERSION IN A COUPLED PHYSICAL-BIOGEOCHEMICAL MODEL}
\end{center}
\end{minipage}\\
\end{tabular}
    {\large
\ding{226} An idealized model is set up to confirm the efficiency of the method: \\
$\bullet$ NEMO (dynamics) + LOBSTER (biogeochemics) models. \\
$\bullet$ Channel domain: 478~km $\times$ 500~km $\times$ 4~ km, horizontal resolution: 2km \\ 
$\bullet$ Unstable baroclinic jet dynamics\\  
\ding{226} Inversion of Chlorophyll and SST images to correct a perturbed velocity: \\
...
\begin{center}
\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGvel_0324_pert_mod.eps}%{0.99}
\\
...
\begin{minipage}{0.21\textwidth}
\begin{center}
\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGvel_0324_0017_mod.eps}%{0.99}
\\
{\small \bf Corrected velocity}
\end{center}
\end{minipage}
\begin{minipage}{0.21\textwidth}
\begin{center}
\includegraphics[width=1\linewidth]{./pict/sa_uv-R2BIGvel_0324_F_mod.eps}%{0.99}
\\
...
\pbox{0.80\textwidth}{}{linewidth=0.5mm,framearc=0.2,linecolor=black, fillstyle=gradient,gradangle=0,gradbegin=white,gradend=white, gradmidpoint=0.0,framesep=3mm, shadowsize=0pt}{
A perturbed velocity is corrected using the Chlorophyll image and the Sea Surface Temperature of the model. Comparing the corrected velocity with the true one (using $\ell 2$-norm), we found that about 40\% of the error is corrected.} \vspace{1cm}
%\end{center}
\end{minipage}
  } %large
  } %pbax 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
  \pbox{0.90\columnwidth}{17.0cm}{linewidth=2mm,framearc=0.1,linecolor=mycyan,fillstyle=gradient,gradangle=0,gradbegin=white,gradend=white,gradmidpoint=1.0,framesep=1em}{
    \begin{center}{\sc \bf \Large  CONCLUSION\\[5mm]} \end{center}
    {\large
     \begin{center}
      \pbox{0.90\columnwidth}{}{linewidth=0.5mm,framearc=0.2,linecolor=black, fillstyle=gradient,gradangle=0,gradbegin=myorange,gradend=myorange, gradmidpoint=0.0,framesep=3mm, shadowsize=0pt}{ We succeeded in correcting an altimetric mesoscale velocity field using a sub-mesoscale tracer observation from space }
      \end{center}
      ...
      Knowing the true sub-mesoscale velocity,  nearly 40\% of the error on the velocity can be corrected during the tracer inversion process. \\ %assessed how much the corrected velocity is a better match to the tracer than the mesoscale `observed' velocity. \\ 
      \ding{226} This study opens the way for the use of very high resolution altimeter data (in the context of SWOT and SARAL projects). The strategy proposed in here will also be helpful to handle huge amount of data in models. 
